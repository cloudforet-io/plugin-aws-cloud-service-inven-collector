...
instance_total_count_conf = os.path.join(
    current_dir, "widget/instance_total_count.yaml"
)
...
cst_elb._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source("VPC ID", "data.vpc_id", options={"is_optional": True}),
        ListDyField.data_source(
            "Subnet ID",
            "data.availability_zones",
            options={"delimiter": "<br>", "sub_key": "subnet_id", "is_optional": True},
        ),
        ListDyField.data_source(
            "Availability Zone",
            "data.availability_zones",
            options={"delimiter": "<br>", "sub_key": "zone_name", "is_optional": True},
        ),
        TextDyField.data_source(
            "Hosted Zone ID",
        ...
        ListDyField.data_source(
            "Protocols",
            "data.listeners",
            options={"delimiter": "<br>", "sub_key": "protocol", "is_optional": True},
        ),
        ListDyField.data_source(
            "Ports",
            "data.listeners",
            options={"delimiter": "<br>", "sub_key": "port", "is_optional": True},
        ),
        TextDyField.data_source(
            "IP Address Type", "data.ip_address_type", options={"is_optional": True}
        ),
        TextDyField.data_source(
        ...
        TextDyField.data_source(
            ...
            "data.attributes.routing_http2_enabled",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Idel Timeout Seconds",
            "data.attributes.idle_timeout_seconds",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
        ...
        TextDyField.data_source(
            ...
            "data.attributes.waf_fail_open_enabled",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Deletion Protection Enabled",
            "data.attributes.deletion_protection_enabled",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
    ...
    search=[
        ...
        SearchField.set(
            name="Availability Zone", key="data.availability_zones.zone_name"
        ),
        ...
        SearchField.set(
            ...
            key="data.attributes.deletion_protection_enabled",
            data_type="boolean",
        ),
        SearchField.set(
            name="Cross-Zone Load Balancing",
            key="data.attributes.load_balancing_cross_zone_enabled",
            data_type="boolean",
        ),
        ...
        SearchField.set(
            name="Target Group ARN", key="data.target_groups.target_group_arn"
        ),
        SearchField.set(
            name="Target Group Name", key="data.target_groups.target_group_name"
        ),
        ...
        SearchField.set(name="Security Policy", key="data.listeners.ssl_policy"),
    ],
    widget=[
...
cst_tg._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        ListDyField.data_source(
            "Load Balancers", "data.load_balancer_arns", options={"delimiter": "<br>"}
        ),
        EnumDyField.data_source(
            "Health Check",
        ...
        TextDyField.data_source(
            "ARN", "data.target_group_arn", options={"is_optional": True}
        ),
        TextDyField.data_source("VPC ID", "data.vpc_id", options={"is_optional": True}),
        TextDyField.data_source(
            "Healthy Threshold Count",
            "data.healthy_threshold_count",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Unhealthy Threshold Count",
            "data.unhealthy_threshold_count",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
        ...
        TextDyField.data_source(
            ...
            "data.health_check_interval_seconds",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Deregistration Delay Timeout Seconds",
            "data.deregistration_delay_timeout_seconds",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Slow Start Duration Seconds",
            "data.slow_start_duration_seconds",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Stickiness Enabled",
            "data.stickiness_enabled",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Stickiness Type", "data.stickiness_type", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Load Balancing Algorithm Type",
            "data.load_balancing_algorithm_type",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Stickiness LB Cookie Duration Seconds",
            "data.stickiness_lb_cookie_duration_seconds",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "AWS Account ID", "account", options={"is_optional": True}
    ...
    search=[
        ...
        SearchField.set(
            ...
            enums={"Enabled": {"label": "Enabled"}, "Disabled": {"label": "Disabled"}},
        ),
        SearchField.set(
