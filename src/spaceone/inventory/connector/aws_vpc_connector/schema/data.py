...
class RouteTableRoutes(Model):
    destination_cidr_block = StringType(deserialize_from="DestinationCidrBlock", serialize_when_none=False)
    destination_ipv6_cidr_block = StringType(deserialize_from="DestinationIpv6CidrBlock", serialize_when_none=False)
    destination_prefix_list_id = StringType(deserialize_from="DestinationPrefixListId", serialize_when_none=False)
    egress_only_internet_gateway_id = StringType(deserialize_from="EgressOnlyInternetGatewayId", serialize_when_none=False)
    ...
    instance_owner_id = StringType(deserialize_from="InstanceOwnerId", serialize_when_none=False)
    nat_gateway_id = StringType(deserialize_from="NatGatewayId", serialize_when_none=False)
    transit_gateway_id = StringType(deserialize_from="TransitGatewayId", serialize_when_none=False)
    local_gateway_id = StringType(deserialize_from="LocalGatewayId", serialize_when_none=False)
...
class RouteTable(AWSCloudService):
    ...
    edge_associations = ListType(ModelType(RouteTableAssociations), deserialize_from="EdgeAssociations", default=[])
