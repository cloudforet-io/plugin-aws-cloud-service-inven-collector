...
from spaceone.inventory.connector.aws_vpc_connector.schema.data import (
    VPC,
    Subnet,
    RouteTable,
    InternetGateway,
...
vpc = ItemDynamicLayout.set_fields(
    ...
    fields=[
        ...
        ListDyField.data_source(
            "IPv4 CIDR",
            "data.cidr_blocks",
            default_badge={"sub_key": "cidr_block", "delimiter": "<br>"},
        ),
        ListDyField.data_source(
            "IPv6 CIDR",
            "data.ipv6_cidr_block_association_set",
            default_badge={"type": "outline", "sub_key": "ipv6_cidr_block"},
        ),
        EnumDyField.data_source(
            "DNS resolution",
...
vpc_route = TableDynamicLayout.set_fields(
    ...
    fields=[
        ...
        EnumDyField.data_source(
            "Main", "main", default_badge={"indigo.500": ["Yes"], "coral.600": ["No"]}
        ),
        ListDyField.data_source(
            "Routes",
            "routes",
...
vpc_igw = ItemDynamicLayout.set_fields(
    "Internet Gateway",
    fields=[
        TextDyField.data_source(
            "Internet Gateway ID", "data.internet_gateway.internet_gateway_id"
        ),
        EnumDyField.data_source(
            "State",
            "data.internet_gateway.state",
            default_state={
...
vpc_natgw = TableDynamicLayout.set_fields(
    "NAT Gateway",
    "data.nat_gateways",
    fields=[
...
vpc_endpoints = TableDynamicLayout.set_fields(
    "Endpoint",
    "data.endpoints",
    fields=[
        ...
        EnumDyField.data_source(
            "Endpoint Type",
            "vpc_endpoint_type",
            default_outline_badge=["Interface", "Gateway"],
        ),
    ],
)

vpc_peercon = TableDynamicLayout.set_fields(
    "Peering Connection",
...
vpc_egress_gw = ItemDynamicLayout.set_fields(
    "Egress Only Internet Gateway",
    "data.egress_only_internet_gateway",
    fields=[
        TextDyField.data_source(
        ...
        ListDyField.data_source(
            "State",
            "data.attachments",
            default_badge={"type": "inline", "sub_key": "state"},
        ),
    ],
)

vpn_gw = ItemDynamicLayout.set_fields(
    "VPN Gateway",
    fields=[
        ...
        ListDyField.data_source(
            "VPC",
            "data.vpn_gateway.vpc_attachments",
            default_badge={
                "type": "outline",
                "sub_key": "vpc_id",
            },
        ...
        TextDyField.data_source(
            "ASN (Amazon side)", "data.vpn_gateway.amazon_side_asn"
        ),
    ],
)

vpc_transit_gw = ItemDynamicLayout.set_fields(
    "Transit Gateway",
    fields=[
        TextDyField.data_source("Name", "data.transit_gateway.name"),
        TextDyField.data_source(
            "Transit Gateway ID", "data.transit_gateway.transit_gateway_id"
        ),
        TextDyField.data_source("Owner Account ID", "data.transit_gateway.owner_id"),
        EnumDyField.data_source(
            "State",
            "data.transit_gateway.state",
            default_state={
                "safe": ["available"],
        ...
        EnumDyField.data_source(
            "DNS Support",
            "data.transit_gateway.options.dns_support",
            default_badge={"indigo.500": ["enable"], "coral.600": ["disable"]},
        ),
        EnumDyField.data_source(
            "VPN ECMP support",
            "data.transit_gateway.options.vpn_ecmp_support",
            default_badge={"indigo.500": ["enable"], "coral.600": ["disable"]},
        ),
        EnumDyField.data_source(
            "Auto accept shared",
            "data.transit_gateway.options.auto_accept_shared_attachments",
            default_badge={"indigo.500": ["enable"], "coral.600": ["disable"]},
        ),
        EnumDyField.data_source(
...
vpc_metadata = CloudServiceMeta.set_layouts(
    layouts=[
        vpc,
        vpc_subnet,
        vpc_route,
...
subnet = ItemDynamicLayout.set_fields(
    ...
    fields=[
        ...
        TextDyField.data_source("IPv4 CIDR", "data.cidr_block"),
        TextDyField.data_source(
            "Available IPv4 Address", "data.available_ip_address_count"
        ),
        ListDyField.data_source(
            "IPv6 CIDR",
            "data.ipv6_cidr_block_association_set",
            default_badge={"sub_key": "ipv6_cidr_block"},
        ),
...
subnet_rt = TableDynamicLayout.set_fields(
    "Route Table",
    "data.route_table.routes",
    fields=[
...
subnet_nacl = TableDynamicLayout.set_fields(
    "Network ACL",
    "data.network_acl.entries",
    fields=[
        EnumDyField.data_source(
            "Direction",
            "direction",
...
rt_routes = TableDynamicLayout.set_fields(
    "Routes",
    "data.routes",
    fields=[
...
rt_subnet_assoc = TableDynamicLayout.set_fields(
    "Subnet Associations",
    "data.subnet_associations",
    fields=[
        TextDyField.data_source("Subnet ID", "subnet_id"),
        ...
        TextDyField.data_source("Route Table ID", "route_table_id"),
        TextDyField.data_source(
            "Route Table Association ID", "route_table_association_id"
        ),
    ],
)

rt_edge_assoc = TableDynamicLayout.set_fields(
    "Edge Assocations",
...
rt_metadata = CloudServiceMeta.set_layouts(
    layouts=[rt, rt_routes, rt_subnet_assoc, rt_edge_assoc]
)

# Internet Gateway
igw = ItemDynamicLayout.set_fields(
    "Internet Gateway",
    fields=[
        ...
        ListDyField.data_source(
            "VPC ID", "data.attachments", options={"sub_key": "vpc_id"}
        ),
    ],
)
...
# Egress Only Internet Gateway
eoigw = ItemDynamicLayout.set_fields(
    "Egress Only Internet Gateway",
    fields=[
        TextDyField.data_source(
...
# ENDPOINT
ep = ItemDynamicLayout.set_fields(
    "Endpoints",
    fields=[
        ...
        EnumDyField.data_source(
            "Endpoint Type",
            "data.vpc_endpoint_type",
            default_outline_badge=["Gateway", "Interface"],
        ),
        ListDyField.data_source(
            "DNS Names",
            "data.dns_entries",
...
# NAT GATEWAY
natgw = ItemDynamicLayout.set_fields(
    "NAT Gateway",
    fields=[
...
peercon_requester = ItemDynamicLayout.set_fields(
    "Requester",
    fields=[
        ...
        TextDyField.data_source(
            "Requester VPC Region", "data.requester_vpc_info.region"
        ),
    ],
)

peercon_accepter = ItemDynamicLayout.set_fields(
    "Accepter",
    fields=[
...
pc_metadata = CloudServiceMeta.set_layouts(
    layouts=[peercon, peercon_requester, peercon_accepter]
)

# NETWORK ACL
nacl = ItemDynamicLayout.set_fields(
    "Network ACL",
    fields=[
...
nacl_inbound = TableDynamicLayout.set_fields(
    "Inbound Rules",
    "data.inbound_entries",
    fields=[
...
nacl_outbound = TableDynamicLayout.set_fields(
    "Outbound Rules",
    "data.outbound_entries",
    fields=[
        TextDyField.data_source("Rule #", "rule_number"),
        EnumDyField.data_source(
            "Protocol",
...
nacl_subnet_assoc = TableDynamicLayout.set_fields(
    "Subnet Associations",
    "data.associations",
    fields=[TextDyField.data_source("Subnet ID", "subnet_id")],
)

nacl_metadata = CloudServiceMeta.set_layouts(
    layouts=[nacl, nacl_inbound, nacl_outbound, nacl_subnet_assoc]
)

# TRANSIT GATEWAY
transitgw = ItemDynamicLayout.set_fields(
    "Transit Gateway",
    fields=[
        TextDyField.data_source("Name", "data.name"),
...
transitgw_vpn_conn = TableDynamicLayout.set_fields(
    "VPN Connections",
...
# CUSTOMER GATEWAY
customergw = ItemDynamicLayout.set_fields(
    "Customer Gateway",
    fields=[
...
customergw_vpn_conn = ItemDynamicLayout.set_fields(
    ...
    fields=[
        ...
        TextDyField.data_source(
            "Virtual Private Gateway", "data.vpn_connection.vpn_gateway_id"
        ),
        TextDyField.data_source(
            "Transit Gateway", "data.vpn_connection.transit_gateway_id"
        ),
        TextDyField.data_source(
            "Customer Gateway", "data.vpn_connection.customer_gateway_id"
        ),
        TextDyField.data_source(
            "Customer Gateway Address", "data.vpn_connection.customer_gateway_address"
        ),
...
customergw_metadata = CloudServiceMeta.set_layouts(
    layouts=[customergw, customergw_vpn_conn]
)

# VPN GATEWAY
vpngw = ItemDynamicLayout.set_fields(
...
vpngw_vpn_conn = ItemDynamicLayout.set_fields(
    "VPN Connection",
    fields=[
        TextDyField.data_source("name", "data.vpn_connection.name"),
        TextDyField.data_source("VPN ID", "data.vpn_connection.vpn_connection_id"),
...
# VPN CONNECTION
vpnconn = ItemDynamicLayout.set_fields(
    "VPN Connection",
    fields=[
        ...
        EnumDyField.data_source(
            "Static Routing Only",
            "data.options.static_routes_only",
            default_badge={"indigo.500": ["true"], "coral.600": ["false"]},
        ),
        EnumDyField.data_source(
            "Enable Acceleration",
...
vpnconn_tunnel = TableDynamicLayout.set_fields(
    "VPN Tunnel",
    "data.vgw_telemetry",
    fields=[
        TextDyField.data_source("Outside IP Address", "outside_ip_address"),
        EnumDyField.data_source(
            "Status", "status", default_state={"safe": ["UP"], "alert": ["DOWN"]}
        ),
...
class VPCResource(_VPCResource):
    ...
    data = ModelType(VPC)
    _metadata = ModelType(
        CloudServiceMeta, default=vpc_metadata, serialized_name="metadata"
    )
...
class SubnetResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=subnet_metadata, serialized_name="metadata"
    )
...
class RouteTableResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=rt_metadata, serialized_name="metadata"
    )
...
class InternetGatewayResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=igw_metadata, serialized_name="metadata"
    )
...
class EgressOnlyInternetGatewayResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=eoigw_metadata, serialized_name="metadata"
    )
...
class EndpointResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=ep_metadata, serialized_name="metadata"
    )
...
class NATGatewayResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=natgw_metadata, serialized_name="metadata"
    )
...
class PeeringConnectionResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=pc_metadata, serialized_name="metadata"
    )
...
class NetworkACLResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=nacl_metadata, serialized_name="metadata"
    )
...
class TransitGatewayResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=transitgw_metadata, serialized_name="metadata"
    )
...
class CustomerGatewayResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=customergw_metadata, serialized_name="metadata"
    )
...
class VPNGatewayResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=vpngw_metadata, serialized_name="metadata"
    )
...
class VPNConnectionResource(_VPCResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=vpnconn_metadata, serialized_name="metadata"
    )
