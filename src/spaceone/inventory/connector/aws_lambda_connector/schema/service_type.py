...
code_total_size_by_account_conf = os.path.join(
    current_dir, "widget/code_total_size_by_account.yaml"
)
memory_total_size_by_account_conf = os.path.join(
    current_dir, "widget/memory_total_size_by_account.yaml"
)
...
cst_function._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        SizeField.data_source(
            "Memory Size", "data.memory_size", options={"source_unit": "MB"}
        ),
        TextDyField.data_source("Description", "data.description"),
        TextDyField.data_source("ARN", "data.arn", options={"is_optional": True}),
        TextDyField.data_source(
            "Version", "data.version", options={"is_optional": True}
        ),
        TextDyField.data_source("Role ARN", "data.role", options={"is_optional": True}),
        TextDyField.data_source(
        ...
        ListDyField.data_source(
            "Layers ARN",
            "data.layers",
            options={"delimiter": "<br>", "sub_key": "arn", "is_optional": True},
        ),
        TextDyField.data_source(
            "KMS Key ARN", "data.kms_key_arn", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Dead Letter Target Name",
            "data.dead_letter_config.target_name",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Dead Letter Target ARN",
            "data.dead_letter_config.target_arn",
            options={"is_optional": True},
        ),
        TextDyField.data_source(
            "Trace Config Mode", "data.trace_config.mode", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Timeout", "data.time_out", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Revision ID", "data.revision_id", options={"is_optional": True}
        ),
        TextDyField.data_source(
            "Master ARN", "data.master_arn", options={"is_optional": True}
        ),
        TextDyField.data_source(
    ...
    search=[
        ...
        SearchField.set(name="Package Type", key="data.package_type"),
        ...
        SearchField.set(
            name="Memory Size (MB)", key="data.memory_size", data_type="integer"
        ),
        ...
        SearchField.set(
            name="Last Modified Time", key="data.last_modified", data_type="datetime"
        ),
